...
**Goal:** Miskolc-alapú, de országos elérhetőségű landing oldalak kiépítése — egy regionális oldal Észak-Magyarország célcsoportjának, és emelt szintű (SEO-optimalizált, FAQ-os, részletes) tartalom a három kiemelt kezelésnél: fogszabályozás, implantátum, fogfehérítés.
...
- A fogszabályozás slug: `fogszabalyozas`, implantátum slug: `fogpotlas` (ellenőrizd az adatbázisban!)
...
```html
<div class="mb-3">
  <label class="form-label">Kiemelt leírás (hosszú, SEO-optimalizált — csak fogszabályozás, implantátum, fogfehérítésnél töltsd ki)</label>
...
1. Admin felületen megnyitni a fogszabályozás kategória szerkesztőjét
...
1. Admin felületen töltsd ki a fogszabályozás kategória `kiemelt_leiras` mezőjét néhány tesztelő bekezdéssel
